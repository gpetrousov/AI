"""Greedy hill climbing with sideways moves
...
def main(chessboard, sideways_moves):
    print 'GREEDY HILL CLIMB WITH SIDEWAYS MOVES'
    no_of_moves = 0
    ...
    while solution_flag != True:
        ...
        if len(move_to) == 0:
            ...
            print 'exiting'
            print_board(chessboard)
            print 'number of moves ',no_of_moves
            print 'sideways moves ',sideways_moves
            print 'final collisions ', find_collisions(chessboard)
            return no_of_moves, find_collisions(chessboard), False
        ###########################################################################################
        ...
        if current_collisions_number == new_collision_number:
            ...
            if sideways_moves == -1:#out of sideways moves
                solution_flag = True
                #print prev_chessboard
                print 'out of sideways moves'
                print_board(prev_chessboard)
                print 'number of moves ',no_of_moves,'\nsideways moves ',sideways_moves + 1,'\nfinal collisions ', find_collisions(chessboard)
                return no_of_moves, find_collisions(chessboard), False
    ...
    return no_of_moves, find_collisions(chessboard), True
